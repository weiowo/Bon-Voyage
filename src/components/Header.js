    ...
    <>
      <Header active={headerBackground?.toString()}>
        ...
        <NavBar active={headerBackground?.toString()}>
          ...
          <StyleNavLink
            style={{
              borderBottom: currentUrl.pathname === '/all-articles' && headerBackground?.toString() ? '1.5px solid black' : currentUrl.pathname === '/all-articles' ? '1.5px solid white' : '',
            }}
            active={headerBackground?.toString()}
            to="/all-articles"
          >
      ...
      <SmallHeader active={headerBackground?.toString()}>
        <Menu
          src={headerBackground?.toString() ? BlackMenuIcon : WhiteMenuIcon}
          active={clicked}
